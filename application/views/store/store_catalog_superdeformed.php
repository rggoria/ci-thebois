<div class="container-fluid py-5" style="background-color: #f3f3f3;">
   <div class="row">
      ...
      <div class="col-md-9">
            <div class="card">
               <img src="https://d1gt5dppxgb6oq.cloudfront.net/topimg/Gundam_LP/img/grades/sd_bb_m.jpg" alt="" class="card-img-top" width="768" height="459">
               <div class="card-body">
                  <h2 class="card-title">SD & BB Gundam</h2>
