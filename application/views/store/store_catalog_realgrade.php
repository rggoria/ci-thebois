<div class="container-fluid py-5" style="background-color: #f3f3f3;">
   <div class="row">
      ...
      <div class="col-md-9">
            <div class="card">
               <img src="https://d1gt5dppxgb6oq.cloudfront.net/topimg/Gundam_LP/img/grades/real_grade_m.jpg" alt="" class="card-img-top" width="768" height="459">
               <div class="card-body">
                  ...
                  <div class="row">
                        <div class="col-lg-3">
                           <div class="card">
                              <img src="https://www.hlj.com/productthumbs/ban/bans65111_0_1671508216.jpg?v=1671508216" alt="" class="card-img-top img-fluid">
                              <div class="card-body">
