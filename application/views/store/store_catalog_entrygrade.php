<div class="container-fluid py-5" style="background-color: #f3f3f3">
   <div class="row">
      ...
      <div class="col-md-9">
            <div class="card">
               <img src="https://d1gt5dppxgb6oq.cloudfront.net/topimg/Gundam_LP/img/grades/entry_grade_m.jpg" alt="" class="card-img-top" width="768" height="459">
               <div class="card-body">
                  <h2 class="card-title">Entry Grade Gundam</h2>
                  ...
                  <div class="row">
                        <div class="col-lg-3">
                           <div class="card">
                              <img src="https://www.hlj.com/productthumbs/ban/bans65111_0_1671508216.jpg?v=1671508216" alt="" class="card-img-top">
                              <div class="card-body">
                                    <h5 class="card-title">Gundam Product Name</h5>
                                    <span class="badge text-bg-warning">Limited Stock</span>
                                    <p class="fw-bold">Pricing</p>
                        ...
                        <div class="col-lg-3">
                           <div class="card">
                              <img src="https://www.hlj.com/productthumbs/ban/bans65113_0_1671508275.jpg?v=1671508275" alt="" class="card-img-top">
                              <div class="card-body">
                                    <h5 class="card-title">Gundam Product Name</h5>
                                    <span class="badge text-bg-warning">Limited Stock</span>
                                    <p class="fw-bold">Pricing</p>
                        ...
                        <div class="col-lg-3">
                           <div class="card">
                              <img src="https://www.hlj.com/productthumbs/ban/bans65313_0_1671508251.jpg?v=1671508251" alt="" class="card-img top">
                              <div class="card-body">
                                    <h5 class="card-title">Gundam Product Name</h5>
                                    <span class="badge text-bg-warning">Limited Stock</span>
                                    <p class="fw-bold">Pricing</p>
                        ...
                        <div class="col-lg-3">
                           <div class="card">
                              <div class="card">
                                    <img src="https://www.hlj.com/productthumbs/ban/bans65024_0_1671508385.jpg?v=1671508385" alt="" class="card-img-top">
                                    <div class="card-body">
                                       <h5 class="card-title">Gundam Product Name</h5>
                                       <span class="badge text-bg-warning">Limited Stock</span>
                                       <p class="f2-bold">Pricing</p>
                                       <button class="btn btn-outline-primary">Add to Cart</button>
                                    </div>
                              </div>
                           </div>
