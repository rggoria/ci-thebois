<div class="container-fluid py-5" style="background-color: #f3f3f3;">
   <div class="row">
      ...
      <div class="col-md-9">
         <div class="card">
            <img src="https://d1gt5dppxgb6oq.cloudfront.net/topimg/Gundam_LP/img/grades/perfect_grade_m.jpg" alt="" class="card-img-top" width="768" height="459">
            <div class="card-body">
               <h2 class="card-title">Perfect Grade Gundam</h2>
               ...
               <div class="row">
                  <?php if (!$product_list == 0): ?>
                     <?php foreach($product_list as $product): ?>
                        <?php if ($product->product_category == 'Perfect Grade'): ?>
                           <div class="col-lg-3">
                              <div class="card">
                                 ...
                                 <div class="card-body">
                                    ...
                                    <a href="<?= site_url('Store/add_cart/' . $product->product_name . '/' . $product->product_price); ?>" class="btn btn-outline-primary">Add to Cart</a>
                                 </div>
                              </div>
                           </div>
                        <?php else: ?>
